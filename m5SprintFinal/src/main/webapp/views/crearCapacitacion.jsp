...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            ...
            <p class="text-center">Utiliza el formulario a continuación para registrar una capacitación para tu equipo. Asegúrate de completar todos los campos requeridos.</p>
            ...
            <form action="CrearCapacitacion" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="detalleCapacitacion" name="detalleCapacitacion" rows="3" required></textarea>
                </div>
