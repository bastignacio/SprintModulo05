		...
		<div class="row">
			...
			<form action="CrearUsuario" method="post" id="userForm" novalidate>
                ...
                <div class="form-group">
                    ...
                    <label for="telefonoUsuario" style="margin-top: 15px" >Telefono del Usuario:</label>
                ...
                <div id="clienteFields" class="d-none">
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback">Por favor, ingrese el Rut válido</div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback">Por favor, ingrese el nombre válido</div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="direccion" class="form-label">Comuna:</label>
